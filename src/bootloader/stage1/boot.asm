...
ebr_volume_id:             db 20h, 26h, 40h, 69h
ebr_volume_label:          db 'FISHOS 0009'
ebr_system_id:             db 'FAT12   '         ; 8 bytes

;
; Code/main core of system
;
start:
    ; setup data segments
    mov ax, 0
...
.load_kernel_loop:
    ...
    add ax, 31 ; first cluster = (kernel_cluster number - 2) * sectors_per_cluster + kernel_cluster
    ...
    mov si, buffer
    add si, ax
    mov ax, [ds:si] ; read entry from FAT table at
